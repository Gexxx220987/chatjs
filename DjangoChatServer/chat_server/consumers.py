...
class WSConsumer(WebsocketConsumer):
    ...
    def all_user(self, text_data=None):
        ...
        if message['order'] == "send_list_users":
            ...
            print('новый список юзеров отправлен всем')
        if message['order'] == "send_list_rooms":
            self.send(json.dumps(roomlist()))
            print('новый список комнат отправлен всем')
    ...
    def receive(self, text_data=None, bytes_data=None):
        ...
        if 'load' in message:
            ...
            if message['load'] == 'messageList':
                ...
                print('список сообщений комнаты ID:', message['newroom_id'], 'отправлен')
